 ...
 */
export function isFilesystemProviderLimits(limits) {
  return (
    limits !== null &&
    typeof limits === 'object' &&
    /** @type {Record<string, unknown>} */ (limits).transport === 'filesystem'
  );
}
 ...
 */
export function isHttpProviderLimits(limits) {
  return (
    limits !== null &&
    typeof limits === 'object' &&
    /** @type {Record<string, unknown>} */ (limits).transport === 'http'
  );
}
