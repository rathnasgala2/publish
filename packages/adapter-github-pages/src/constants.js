/**
 * Closed constants for the managed `github-pages` adapter: the reserved
 * public-marker coordinate, the exact GitHub Pages deployment status
 * vocabulary and its terminal/temporary partition, the exact poll schedule,
 * and every domain separator this package owns (slice brief
 * `S4-workflow-build-deploy-certification.md` sections 5 and 6.2; DEC-097
 * section 7's `github-pages` row).
 *
 * @module
 */
 ...
 */
export const POLL_SCHEDULE_SECONDS = Object.freeze([5, 8, 12, 18, 27, 30]);
...
export const DOMAIN_PAGES_CREDENTIAL_EGRESS =
  'GALA-PAGES-CREDENTIAL-EGRESS-V2\0';

/** Domain separator: an intervening run attempt's no-authority tombstone. */
export const DOMAIN_PAGES_NO_AUTHORITY_RUN_ATTEMPT =
  'GALA-PAGES-NO-AUTHORITY-RUN-ATTEMPT-V2\0';

/** Domain separator: the run-attempt gap proof record. */
export const DOMAIN_PAGES_RUN_ATTEMPT_GAP_PROOF =
  'GALA-PAGES-RUN-ATTEMPT-GAP-PROOF-V2\0';

/** Domain separator: the `pagesReconciliationRecovery` record. */
export const DOMAIN_PAGES_RECONCILIATION_RECOVERY =
  'GALA-PAGES-RECONCILIATION-RECOVERY-V2\0';
...
export const AUTHORITY_MODES = Object.freeze([NORMAL_MODE, RECOVERY_MODE]);
