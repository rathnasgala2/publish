...
export const LOCAL_REGISTRY_STANDIN = `https://${LOCAL_STANDIN_AUTHORITY}/rathnasgala2/`;
 ...
 */
export const LOCAL_REPOSITORY_COORDINATE_STANDIN =
  'local-development/no-repository-coordinate.invalid';

/** Placeholder workflow-identity source text (digested before use — see `provenance.js`) outside a real Action run. */
export const LOCAL_WORKFLOW_IDENTITY_STANDIN = `${LOCAL_STANDIN_AUTHORITY}/no-workflow-identity`;
