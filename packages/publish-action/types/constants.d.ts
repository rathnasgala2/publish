 ...
 */
export const REPOSITORY_ROOT_DOMAIN: "GALA-PUBLISH-ACTION-REPOSITORY-ROOT-V2\0";
/** Domain-separation tag for this package's local source-revision stand-in. */
export const LOCAL_SOURCE_REVISION_DOMAIN: "GALA-PUBLISH-ACTION-LOCAL-SOURCE-REVISION-V2\0";
/** Domain-separation tag for this package's local package-identity stand-ins. */
export const LOCAL_PACKAGE_IDENTITY_DOMAIN: "GALA-PUBLISH-ACTION-LOCAL-PACKAGE-IDENTITY-V2\0";
