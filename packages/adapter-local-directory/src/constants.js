...
export const HISTORY_FILE_RELATIVE = `${CONTROL_DIR}/history.json`;

/** Idempotency journal file (adapter-private bookkeeping). */
export const JOURNAL_FILE_RELATIVE = `${CONTROL_DIR}/journal.json`;
...
export const DOMAIN_LOCAL_PROBE_TRANSCRIPT =
  'GALA-LOCAL-FILESYSTEM-PROBE-TRANSCRIPT-V2\0';
...
export const DOMAIN_LOCAL_CAPABILITY_EVIDENCE =
