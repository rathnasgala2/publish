...
export const DOMAIN_SPACES_RESPONSE_CATALOG: "GALA-SPACES-RESPONSE-CATALOG-V2\0";
...
export const DOMAIN_SPACES_CREDENTIAL_EGRESS: "GALA-SPACES-CREDENTIAL-EGRESS-V2\0";
/** Domain separator: the exact served-bucket website configuration record. */
export const DOMAIN_SPACES_WEBSITE_CONFIGURATION: "GALA-SPACES-WEBSITE-CONFIGURATION-V2\0";
/** Domain separator: the control-plane credential binding record. */
export const DOMAIN_SPACES_CONTROL_BINDING: "GALA-SPACES-CONTROL-PLANE-BINDING-V2\0";
/** Domain separator: the control-plane request catalog (DEC-097 section 7). */
export const DOMAIN_SPACES_CONTROL_REQUESTS: "GALA-DO-SPACES-CONTROL-PLANE-REQUESTS-V2\0";
/** Domain separator: the control-plane response catalog (DEC-097 section 7). */
export const DOMAIN_SPACES_CONTROL_RESPONSES: "GALA-DO-SPACES-CONTROL-PLANE-RESPONSES-V2\0";
/** Domain separator: the closed Spaces key/SigV4 credential-format release. */
export const DOMAIN_SPACES_CONTROL_CREDENTIAL_FORMAT: "GALA-DO-SPACES-CONTROL-PLANE-CREDENTIAL-FORMAT-V2\0";
/** Domain separator: the control-plane network-boundary profile. */
export const DOMAIN_SPACES_CONTROL_NETWORK_BOUNDARY: "GALA-DO-SPACES-CONTROL-PLANE-NETWORK-BOUNDARY-V2\0";
